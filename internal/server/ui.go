...
const dashHTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Recipe</title>
...
<div class="hdr"><h1><span>&#9670;</span> RECIPE</h1><button class="btn btn-p" id="add-btn">+ Add</button></div>
<div class="main">
<div class="stats" id="stats-recipes"></div>
<div class="toolbar">
<input class="search" id="search-recipes" placeholder="Search..." oninput="renderRes('recipes')"><select class="filter-sel" id="filter-recipes-category" onchange="renderRes('recipes')"><option value="">All Category</option><option value="Appetizer">Appetizer</option><option value="Main Course">Main Course</option><option value="Side Dish">Side Dish</option><option value="Dessert">Dessert</option><option value="Beverage">Beverage</option><option value="Snack">Snack</option><option value="Sauce">Sauce</option><option value="Other">Other</option></select></div>
<div class="count-label" id="count-recipes"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Title</th><th>Category</th><th>Prep Time (min)</th><th>Cook Time (min)</th><th>Servings</th><th>Ingredients</th><th>Instructions</th><th>Notes</th><th>Source</th><th>Tags</th><th></th></tr></thead><tbody id="tbody-recipes"></tbody></table></div></div><div class="modal-bg" id="mbg" onclick="if(event.target===this)closeModal()"><div class="modal" id="mdl"></div></div><script>var A="/api",data={},editId=null,activeRes="recipes";var resCfg={"recipes":{d:"Recipes",f:[{n:"title",l:"Title",t:"text",r:true,o:[]},{n:"category",l:"Category",t:"select",r:false,o:["Appetizer","Main Course","Side Dish","Dessert","Beverage","Snack","Sauce","Other"]},{n:"prep_time",l:"Prep Time (min)",t:"integer",r:false,o:[]},{n:"cook_time",l:"Cook Time (min)",t:"integer",r:false,o:[]},{n:"servings",l:"Servings",t:"integer",r:false,o:[]},{n:"ingredients",l:"Ingredients",t:"textarea",r:true,o:[]},{n:"instructions",l:"Instructions",t:"textarea",r:true,o:[]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]},{n:"source",l:"Source",t:"text",r:false,o:[]},{n:"tags",l:"Tags",t:"text",r:false,o:[]}]},};
